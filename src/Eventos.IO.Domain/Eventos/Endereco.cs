...
namespace Eventos.IO.Domain.Eventos
{
    public class Endereco : Entity<Endereco>
    {
        ...
        public Endereco(Guid id, string lougradouro, string numero, string complemento, string bairro, string cep, string cidade, string estado, Guid? eventoId)
        {
            Id = id;
        ...
        public override bool EhValido()
        {
            RuleFor(c => c.Logradouro)
                .NotEmpty().WithMessage("O Lougradouro precisa ser fornecido")
                .Length(2, 150).WithMessage("O Lougradouro precisa ter entre 2 e 150 caracteres");
